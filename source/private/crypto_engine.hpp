...
class CryptoEngine : public ctgp::common::RootClass {
  public:
     ...
     * @retval None
     */
    void AES_Encrypt16(uint8_t* key, uint8_t* iv, uint8_t* source, uint8_t* dest, size_t length);
     ...
     * @retval None
     */
    void AES_Decrypt16(uint8_t* key, uint8_t* iv, uint8_t* source, uint8_t* dest, size_t length);
     ...
     * @retval None
     */
    void AES_Encrypt32(uint8_t* key, uint8_t* iv, uint8_t* source, uint8_t* dest, size_t length);
     ...
     * @retval None
     */
    void AES_Decrypt32(uint8_t* key, uint8_t* iv, uint8_t* source, uint8_t* dest, size_t length);
     ...
     * @retval None
     */
    void RC4_EncryptDecrypt(uint8_t* key, size_t keylen, uint8_t* source, uint8_t* dest, size_t data_len, size_t offset = 0);
