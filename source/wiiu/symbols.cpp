...
int (*OSDynLoad_Acquire)(const char* dynLoadExeName, uint32_t* outHandle) = (int (*)(const char*, uint32_t*))0x0102A3B4;
int (*OSDynLoad_FindExport)(uint32_t handle, bool isFromDataSection, const char* name, void** fpptr) = (int (*)(uint32_t, bool, const char*, void**))0x0102B828;
...
void* (*memoryAllocAlign)(size_t size, size_t align) = (void* (*)(size_t, size_t))0x1048d10;
...
int (*FSReadFile)(FSClient* client, FSCmdBlock* block, void* buffer, uint32_t count, size_t size, int handle, uint32_t unk1, uint32_t flags);
...
void LoadWiiUSymbols() {
    ...
    uint32_t __rpl_coreinit, __rpl_nsysnet, __rpl_sysapp, __rpl_vpad, __rpl_nn_save, __rpl_proc_ui, __rpl_gx2, __rpl_nn_act;
    ...
    __load_from_module(__rpl_nn_act, "GetSlotNo__Q2_2nn3actFv", (void**)&nn::act::GetSlotNo);
    __load_from_module(__rpl_nn_act, "GetAccountIdEx__Q2_2nn3actFPcUc", (void**)&nn::act::GetAccountIdEx);
    __load_from_module(__rpl_nn_act, "GetMiiName__Q2_2nn3actFPw", (void**)&nn::act::GetMiiName);
