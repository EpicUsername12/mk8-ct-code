...
void Page_TitleTop_AttachementRedirection(ui::UIPage* _this) {
    ((ui::Page_TitleTop*)(_this))->mainControl->setMessage("T_VerNum_00", u"CTGP");
}

ui::UIControl* raceViewMainControl = NULL;
DECL_CXX_HOOK(int, ui::Page_Race::bindWindowLayout_, ui::UIPage* _this, ui::UIControl* mainControl, void* raceWindow) {
...
DECL_CXX_HOOK(int, nn::nex::JobCafeLogin::NexAuthenticationFunc, void* _this, void* arg) {
...
int MainThread(int argc, void* argv) {
    ...
    ctgp::GlobalPatchInstance->RegisterAttachRedirection(ui::Page_TitleTop::ID, Page_TitleTop_AttachementRedirection);
    ...
    while (1) {
        ...
        if (*object::spRaceDirector &&                         // if race director exists
            *(uint32_t*)((*object::spRaceDirector) + 0x238) && // and if the race state ptr was allocated
            object::IsRaceState() &&                           // and if we're in a race
            raceViewMainControl)                               // and raceViewControl was created
        {
            object::KartDirector* kartDirector = (object::KartDirector*)*object::spKartDirector;
            float speed = kartDirector->getKartUnit(0)->vehicle->vehicleMove->driveSpd * 12.0f;
            char buffer[32];
